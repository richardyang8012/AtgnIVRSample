...
namespace Microsoft.Bot.Sample.SimpleEchoBot
{
    public static class IvrOptions
    {
        ...
        internal const string MoreInfoPrompt =
            "AltiGen is the leading Cloud Service Provider in the United States. Our company was established in 1994 and currently has more than 10,000 customers.";
        ...
        internal const string Offer = "You can sign up for 100 megabit connection just for 10 dollars per month till the end of month";
        internal const string CurrentOutages = "There is currently 1 outage in San Jose 5, we are working on fixing the issue";
